...
class BLOOMScorer:
    def __init__(self, device='cuda:0', max_length=1024, checkpoint='bigscience/bloom-560m', type='560m', batch_size=10):
        # Set up model
        self.device = device
        self.type = type
        ...
        self.model = BloomForCausalLM.from_pretrained(checkpoint, cache_dir='', device_map='auto')
        self.model.eval()
        self.model.to(device)


    def score(self, srcs, tgts):
